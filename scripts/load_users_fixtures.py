...
print(f"DEBUG: load_users_fixtures.py execution started at {time.time()}")
...
# Define fixture files for the Users app
USERS_FIXTURES = [
    ("users/fixtures/users.json", User),
]

# Database assigned to the Users app
DATABASE_NAME = "users_db"

"""
Loads fixture data into the 'users_db'.
    - Ensures user-related data is available.
...
"""
def load_users_fixtures():
    
    # DEBUG: Start fixture loading for Users app
    print(f"DEBUG: Starting fixture loading for Users app at {time.time()}")

    for fixture, model in USERS_FIXTURES:
    ...
    try:
        if all(model.objects.exists() for _, model in USERS_FIXTURES):
            
            # DEBUG: All loaded successfully
            print(f"DEBUG: All user fixtures loaded successfully.")
        
        else:
            
            # ERROR: Some user fixture data is missing after loading
            print(f"ERROR: Some user fixture data is missing after loading. Exiting.")
    ...
    # DEBUG: Users fixtures loaded successfully
    print(f"DEBUG: Users fixtures loaded successfully. Exiting script at {time.time()}")
